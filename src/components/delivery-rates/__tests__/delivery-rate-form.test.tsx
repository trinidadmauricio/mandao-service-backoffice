...
import {
  ...
  useDeliveryRate,
} from "@/lib/hooks/use-delivery-rates";
...
const mockUseCreateDeliveryRate = useCreateDeliveryRate as jest.MockedFunction<
  typeof useCreateDeliveryRate
>;
const mockUseUpdateDeliveryRate = useUpdateDeliveryRate as jest.MockedFunction<
  typeof useUpdateDeliveryRate
>;
const mockUseDeliveryRate = useDeliveryRate as jest.MockedFunction<
  typeof useDeliveryRate
>;
const mockUseDeliveryZones = useDeliveryZones as jest.MockedFunction<
  typeof useDeliveryZones
>;
...
describe("DeliveryRateForm", () => {
  ...
  beforeEach(() => {
    ...
    mockUseCreateDeliveryRate.mockReturnValue(defaultMutationReturn as ReturnType<typeof useCreateDeliveryRate>);
    mockUseUpdateDeliveryRate.mockReturnValue(defaultMutationReturn as ReturnType<typeof useUpdateDeliveryRate>);
    mockUseDeliveryRate.mockReturnValue({
      data: undefined,
      isLoading: false,
      error: null,
    } as ReturnType<typeof useDeliveryRate>);
