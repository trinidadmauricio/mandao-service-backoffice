...
const mockUseDeliveryZone = useDeliveryZone as jest.MockedFunction<typeof useDeliveryZone>;
...
describe('DeliveryZoneForm', () => {
  ...
  beforeEach(() => {
    ...
    mockUseCreateDeliveryZone.mockReturnValue(defaultMutationReturn as any);
    mockUseUpdateDeliveryZone.mockReturnValue(defaultMutationReturn as any);
