...
const mockUseCreateVehicle = useCreateVehicle as jest.MockedFunction<
  typeof useCreateVehicle
>;
const mockUseUpdateVehicle = useUpdateVehicle as jest.MockedFunction<
  typeof useUpdateVehicle
>;
...
describe("VehicleForm", () => {
  ...
  beforeEach(() => {
    ...
    mockUseCreateVehicle.mockReturnValue(defaultMutationReturn as ReturnType<typeof useCreateVehicle>);
    mockUseUpdateVehicle.mockReturnValue(defaultMutationReturn as ReturnType<typeof useUpdateVehicle>);
